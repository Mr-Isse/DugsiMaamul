...
router.use('/departments', checkModuleAccess('settings'));
router.route('/departments')
  .get(checkPermission('settings.view'), asyncHandler(getDepartments))
  .post(checkPermission('settings.manage'), asyncHandler(createDepartment));

router.route('/departments/:id')
  .get(checkPermission('settings.view'), asyncHandler(getDepartmentById))
  .put(checkPermission('settings.manage'), asyncHandler(updateDepartment))
  .delete(checkPermission('settings.manage'), asyncHandler(deleteDepartment));

router.route('/designations')
  .get(checkPermission('settings.view'), asyncHandler(getDesignations))
  .post(checkPermission('settings.manage'), asyncHandler(createDesignation));

router.route('/designations/:id')
  .put(checkPermission('settings.manage'), asyncHandler(updateDesignation))
  .delete(checkPermission('settings.manage'), asyncHandler(deleteDesignation));
...
// --- 10. Exam Hall Management ---
router.use('/exam-halls', checkModuleAccess('exams'));
router.route('/exam-halls')
  .post(checkPermission('exams.create'), asyncHandler(createExamHall))
  .get(checkPermission('exams.view'), asyncHandler(getExamHalls));

router.get('/exam-halls/:id', checkPermission('exams.view'), asyncHandler(getExamHallById));
router.put('/exam-halls/:id', checkPermission('exams.edit'), asyncHandler(updateExamHall));
router.delete('/exam-halls/:id', checkPermission('exams.delete'), asyncHandler(deleteExamHall));
router.post('/exam-halls/:id/assign-student', checkPermission('exams.edit'), asyncHandler(assignStudentToHall));
router.delete('/exam-halls/:id/students/:studentId', checkPermission('exams.edit'), asyncHandler(removeStudentFromHall));
router.post('/exam-halls/grant-clearance', checkPermission('exams.edit'), asyncHandler(grantTemporaryClearance));
router.post('/exam-halls/revoke-clearance', checkPermission('exams.edit'), asyncHandler(revokeTemporaryClearance));
router.get('/exam-halls/available-students', checkPermission('exams.view'), asyncHandler(getAvailableStudentsForHall));

// --- 11. Payment & Finance Management ---
...
router.get('/admissions/:id', checkModuleAccess('admissions'), asyncHandler(getAdmission));
router.post('/admissions', checkModuleAccess('admissions'), asyncHandler(createAdmission));
router.put('/admissions/:id', checkModuleAccess('admissions'), asyncHandler(updateAdmission));
router.put('/admissions/:id/status', checkModuleAccess('admissions'), asyncHandler(updateAdmissionStatus));
router.delete('/admissions/:id', checkModuleAccess('admissions'), asyncHandler(deleteAdmission));
