...
import documentWorkflowRoutes from './routes/documentWorkflowRoutes.js';
import advancedSecurityRoutes from './routes/advancedSecurityRoutes.js';
import apiPlatformRoutes from './routes/apiPlatformRoutes.js';
import systemHealthRoutes from './routes/systemHealthRoutes.js';
import whiteLabelRoutes from './routes/whiteLabelRoutes.js';
import dynamicConfigRoutes from './routes/dynamicConfigRoutes.js';
import enterpriseFeatureRoutes from './routes/enterpriseFeatureRoutes.js';
...
app.use('/api/v1/documents', documentWorkflowRoutes);
app.use('/api/v1/advanced-security', advancedSecurityRoutes);
...
app.use('/api/v1/dynamic-config', dynamicConfigRoutes);
app.use('/api/v1/enterprise', enterpriseFeatureRoutes);
