...
export const CLOUDINARY_CONFIG = {
  // Maximum file size: 5MB for User Profile Images, 10MB for general documents
  MAX_FILE_SIZE: 10 * 1024 * 1024, // 10MB in bytes (general)
  MAX_IMAGE_SIZE: 5 * 1024 * 1024,  // 5MB in bytes (user profile photos)
  
  // Allowed image formats. SVG and GIF intentionally excluded:
  // SVG can carry executable markup; GIF removed per Student Photo requirements.
