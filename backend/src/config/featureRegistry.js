...
export const FEATURE_REGISTRY = [
  ...
  // ── Automation ──────────────────────────────────────────────────────
  { code: 'workflow-automation', label: 'Workflow Automation', category: 'Automation' },
  { code: 'automation-engine',   label: 'Automation Engine',   category: 'Automation' },

  // ── Intelligence (Phase 20-21) ─────────────────────────────────────
  { code: 'cross-school-analytics', label: 'Cross-School Analytics', category: 'Intelligence' },
  { code: 'regional-dashboard',     label: 'Regional Dashboard',     category: 'Intelligence' },

  // ── Security (Phase 23) ────────────────────────────────────────────
  { code: 'advanced-security', label: 'Advanced Security', category: 'Security' },

  // ── Platform (Phase 24-26, 29) ─────────────────────────────────────
  { code: 'api-platform',   label: 'API Platform',    category: 'Platform' },
  { code: 'system-health',  label: 'System Health',   category: 'Platform' },
  { code: 'backup',         label: 'Backup Management', category: 'Platform' },
  { code: 'dynamic-config', label: 'Dynamic Configuration', category: 'Platform' },

  // ── Branding (Phase 27) ────────────────────────────────────────────
  { code: 'white-label',    label: 'White Label',     category: 'Branding' },

  // ── Enterprise (Phase 30) ──────────────────────────────────────────
  { code: 'ticketing',          label: 'Ticket System',          category: 'Enterprise' },
  { code: 'task-management',    label: 'Task Management',        category: 'Enterprise' },
  { code: 'announcements',      label: 'Announcements',          category: 'Enterprise' },
  { code: 'complaints',         label: 'Complaint Management',   category: 'Enterprise' },
  { code: 'suggestions',        label: 'Suggestion Box',         category: 'Enterprise' },
  { code: 'risk-register',      label: 'Risk Register',          category: 'Enterprise' },
  { code: 'knowledge-base',     label: 'Knowledge Base',         category: 'Enterprise' },
  { code: 'meeting-scheduler',  label: 'Meeting Scheduler',      category: 'Enterprise' },
  { code: 'incident-management', label: 'Incident Management',   category: 'Enterprise' },
];
...
export const ENTERPRISE_FEATURES = [
  ...
  // Phase 18-30: Enterprise additions
  'workflow-automation', 'automation-engine',
  'cross-school-analytics', 'regional-dashboard',
  'advanced-security', 'api-platform', 'system-health', 'backup', 'dynamic-config',
  'white-label',
  'ticketing', 'task-management', 'announcements', 'complaints', 'suggestions',
  'risk-register', 'knowledge-base', 'meeting-scheduler', 'incident-management',
];
